...
import { ArrowDownIcon, ArrowUpIcon, BoxesIcon, PencilRulerIcon } from "lucide-react";
    ...
    <>
      <div className="grid gap-4 xl:grid-cols-2">
        <Card className="shadow-none">
          <CardHeader>
            ...
            <CardDescription>Start tracking available stock for a specific sku.</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              >
                <FieldGroup>
                  ...
                  <Field>
                    ...
                    />
                    <FieldDescription>The current full stock available for this sku.</FieldDescription>
                  </Field>
        ...
        <Card className="shadow-none">
          <CardHeader>
            ...
            <CardDescription>Use explicit reasons so audit and webhooks remain readable.</CardDescription>
          </CardHeader>
          <CardContent>
            {snapshot.skus.length === 0 ? (
                    ...
                    <Select value={adjustmentReason} onValueChange={(value) => setAdjustmentReason(value as typeof adjustmentReason)}>
                      ...
                      <SelectContent>
                        <SelectGroup>
                          ...
                          <SelectItem value="EXTERNAL_VENDOR_SALE">vendor sale</SelectItem>
      ...
      <Card className="shadow-none">
        <CardHeader>
          ...
          <CardDescription>Total, reserved, allocated, and available counts by pool.</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                {snapshot.inventoryPools.map((pool) => {
                  const available = pool.totalQuantity - pool.reservedQuantity - pool.allocatedQuantity;
                  return (
                    <TableRow key={pool.id}>
                      <TableCell className="font-medium">{pool.skuId}</TableCell>
